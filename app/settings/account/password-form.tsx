  ...
  return (
    <form onSubmit={handleSubmit} method="post" className="space-y-4">
      <div>
        ...
        <input id="current" name="current" type="password" autoComplete="current-password" required placeholder="현재 비밀번호" className="w-full rounded-lg border border-hairline bg-paper/50 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-signal/60" />
