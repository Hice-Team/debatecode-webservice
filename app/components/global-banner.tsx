...
const BTN_CLASS =
  'shrink-0 rounded-full border border-current/30 bg-surface/15 px-3.5 py-3 text-[11px] font-semibold transition-colors hover:bg-surface/25 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current';
