...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-ink text-white/60 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-white/50 max-w-sm leading-relaxed">{t('footer-desc', language)}</p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-xs text-white/40">
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <Link href="/legal/terms" className="hover:text-white/70 transition underline underline-offset-2">{t('footer-terms', language)}</Link>
              <Link href="/legal/ai-terms" className="hover:text-white/70 transition underline underline-offset-2">{t('footer-ai-terms', language)}</Link>
              <Link href="/legal/privacy" className="hover:text-white/70 transition underline underline-offset-2 font-medium">{t('footer-privacy', language)}</Link>
              <Link href="/legal/consent" className="hover:text-white/70 transition underline underline-offset-2">{t('footer-consent', language)}</Link>
              <Link href="/legal/mate-terms" className="hover:text-white/70 transition underline underline-offset-2">{t('footer-mate-terms', language)}</Link>
            </div>
          </div>
