    ...
    <form action={formAction} className="space-y-3">
      <div>
        ...
        <select
          ...
          required
          defaultValue=""
          className="w-full rounded-lg border border-ink/15 bg-white px-3 py-2.5 text-sm focus:border-signal focus:outline-none focus:ring-2 focus:ring-signal/25"
        >
